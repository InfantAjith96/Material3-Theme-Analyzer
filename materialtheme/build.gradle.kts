...
ext {
    ...
    set("PUBLISH_DESCRIPTION", "Material Theme")
    set("PUBLISH_URL", "https://github.com/material3theme/materialtheme")
    ...
    set("PUBLISH_SCM_CONNECTION", "scm:git:https://github.com/material3theme/materialtheme.git")
    set("PUBLISH_SCM_DEVELOPER_CONNECTION", "scm:git:https://github.com/material3theme/materialtheme.git")
    set("PUBLISH_SCM_URL", "https://github.com/material3theme/materialtheme")
}
